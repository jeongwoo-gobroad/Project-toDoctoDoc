...
class _CurateMainState extends State<CurateMain> {
  ...
  void initState() {
    super.initState();
    curateListController.getCurateList(-1, 5, "");
  ...
  Future<void> _handleCurateRequest() async {
    ...
    if (curateListController.curateFinished.value) {
      ...
      Get.snackbar("오류", "큐레이팅 요청 중 오류가 발생했습니다.");
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  if (appointmentController
                                      .isAfterTodayAppointmentExist.value) ...[
                                    Row(
                                      children: [
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                        '${appointmentController.appointmentList[appointmentController.approvedAppointment]['doctor']['name']}, '
                    ...
                    Obx(() {
                      ...
                      return Container(
                        ...
                        child: ListView.builder(
                          itemCount:
                              (curateListController.CurateList.length > 3)
                                  ? 3
                                  : curateListController.CurateList.length,
                          itemBuilder: (context, index) {
                            final curateList =
                                curateListController.CurateList[index];
                            final commentCount =
                                curateList['comments']?.length ?? 0;
                            return ListTile(
                      ...
                      Obx(() {
                        ...
                        return Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: (chatController.chatList.length > 3)
                                ? 3
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                              onPressed: () {
                                ...
                                // });
                                Get.to(
                                    () => DMList(controller: chatController));
                              },
                              style: TextButton.styleFrom(
                                shape: RoundedRectangleBorder(
                                  borderRadius:
            ...
            AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text(
                    "(최초 수행된 AI 기반 고민 해석본은 하루 동안 유지됩니다.)",
                    //textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.4,
  ...
  onTaptoGo() async {
    ...
    await appointmentController.getAppointmentInformation(appointmentController
        .appointmentList[appointmentController.nearAppointment]['_id']);

    Get.to(() => AppointmentDetailScreen(
        doctorName: appointmentController
                .appointmentList[appointmentController.nearAppointment]
            ['doctor']['name'],
