        ...
        child: ListView.builder(
            ...
            itemBuilder: (_, int index) {
              return Bubble(
                ...
                color: messageList[messageList.length-index-1].role == 'user' ? Colors.black : Colors.white,

                margin: const BubbleEdges.only(top: 8),
                child: Text('${messageList[messageList.length-index-1].content}',
                  style: TextStyle(fontSize: 15,
                      color: messageList[messageList.length-index-1].role == 'user' ? Colors.white : Colors.black),),
              );
            }),
      ),
    );
